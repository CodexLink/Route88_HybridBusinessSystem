...
<MDNavigationDrawer_HeaderStringOnly>:
    _list: list
    _header_name: header_name
    _subheader_name: subheader_name
    spacing: dp(5)
    canvas:
        Color:
            rgba: root.theme_cls.bg_light
...
class MDNavigationDrawer_HeaderStringOnly(BoxLayout, ThemableBehavior,
                         RectangularElevationBehavior):
    _elevation = NumericProperty(0)
    _list = ObjectProperty()
    _header_name = ObjectProperty()
    _subheader_name = ObjectProperty()
    ...
    subheader_name = StringProperty()
    def __init__(self, **kwargs):
        super(MDNavigationDrawer_HeaderStringOnly, self).__init__(**kwargs)
    ...
    def add_widget(self, widget, index=0):
        ...
        if issubclass(widget.__class__, BaseListItem):
            ...
            super(MDNavigationDrawer_HeaderStringOnly, self).add_widget(widget, index)
