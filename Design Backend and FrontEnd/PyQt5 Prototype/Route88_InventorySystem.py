...
class Ui_Route88_InventorySystemView(QtWidgets.QMainWindow):
    def setupUi(self, Route88_InventorySystemView):
        ...
        Route88_InventorySystemView.resize(1133, 608)
        ...
        self.InventoryView_Supplies.setColumnCount(10)
    ...
    def retranslateUi(self, Route88_InventorySystemView):
        ...
        self.TableSystem_Selection.setItemText(0, _translate("Route88_InventorySystemView", "Inventory Table"))
        self.TableSystem_Selection.setItemText(1, _translate("Route88_InventorySystemView", "Supplier Table"))
        self.TableSystem_Selection.setItemText(2, _translate("Route88_InventorySystemView", "Transaction Table"))
        ...
        self.Query_ColumnOpt.setCurrentText(_translate("Route88_InventorySystemView", "All Columns"))
        self.Query_ColumnOpt.setItemText(0, _translate("Route88_InventorySystemView", "All Columns"))
        self.Query_ColumnOpt.setItemText(1, _translate("Route88_InventorySystemView", "Item Code"))
        self.Query_ColumnOpt.setItemText(2, _translate("Route88_InventorySystemView", "Supplier Code"))
        self.Query_ColumnOpt.setItemText(3, _translate("Route88_InventorySystemView", "Item Name"))
        self.Query_ColumnOpt.setItemText(4, _translate("Route88_InventorySystemView", "Type"))
        self.Query_ColumnOpt.setItemText(5, _translate("Route88_InventorySystemView", "Quantity"))
        self.Query_ColumnOpt.setItemText(6, _translate("Route88_InventorySystemView", "Cost"))
        self.Query_ColumnOpt.setItemText(7, _translate("Route88_InventorySystemView", "Expiry Date"))
        self.Query_ColumnOpt.setItemText(8, _translate("Route88_InventorySystemView", "Menu Inclusion"))
        self.Query_ColumnOpt.setItemText(9, _translate("Route88_InventorySystemView", "Data Created"))
        self.Query_ColumnOpt.setItemText(10, _translate("Route88_InventorySystemView", "Last Modified"))
