...
class Ui_Route88_InventorySystemView(QtWidgets.QMainWindow):
    def setupUi(self, Route88_InventorySystemView):
        ...
        Route88_InventorySystemView.resize(1133, 598)
        ...
        self.InventoryTable_View.verticalHeader().setVisible(True)
    ...
    def retranslateUi(self, Route88_InventorySystemView):
        ...
        self.StaffAct_RefreshData.setStatusTip(_translate("Route88_InventorySystemView", "Refreshes Data From Window Session."))
