...
class Ui_Route88_Management_Modifier(QtWidgets.QMainWindow):
    def setupUi(self, Route88_Management_Modifier):
        ...
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(16, 120, 751, 31))
    ...
    def retranslateUi(self, Route88_Management_Modifier):
        ...
        self.Modifier_AddEntry.setStatusTip(_translate("Route88_Management_Modifier", "Add All Encoded Entries."))
        self.Modifier_AddEntry.setText(_translate("Route88_Management_Modifier", "Add Entry"))
        self.Modifier_ClearEntry.setStatusTip(_translate("Route88_Management_Modifier", "Clear All Encoded Entries."))
        self.Modifier_ClearEntry.setText(_translate("Route88_Management_Modifier", "Clear Entry"))
        self.Modifier_CloseWindow.setStatusTip(_translate("Route88_Management_Modifier", "Close \'Add Entry\' Window."))
