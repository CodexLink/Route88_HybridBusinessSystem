...
class Ui_Route88_Controller_Window(object):
    def setupUi(self, Route88_Controller_Window):
        ...
        Route88_Controller_Window.setTabOrder(self.ctrl_UserLogout, self.ctrl_ManageSystem)
        Route88_Controller_Window.setTabOrder(self.ctrl_ManageSystem, self.ctrl_POSSystem)
        Route88_Controller_Window.setTabOrder(self.ctrl_POSSystem, self.ctrl_optHideOnLaunch)
    ...
    def retranslateUi(self, Route88_Controller_Window):
        ...
        self.user_FirstName.setText(_translate("Route88_Controller_Window", "..."))
        ...
        self.ctrl_ManageSystem.setText(_translate("Route88_Controller_Window", "Launch Management System"))
        self.ctrl_POSSystem.setText(_translate("Route88_Controller_Window", "Launch POS System"))
        self.ctrl_optHideOnLaunch.setText(_translate("Route88_Controller_Window", "Hide Window On Launch"))
        self.label.setText(_translate("Route88_Controller_Window", "Route88 Bike Café"))
        self.label_2.setText(_translate("Route88_Controller_Window", "POS and Management System | [Add Time Here]"))
