...
class Ui_Route88_DataViewer_Window(object):
    def setupUi(self, Route88_DataViewer_Window):
        ...
        Route88_DataViewer_Window.resize(1134, 596)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.TableSystem_Selection.setFont(font)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.Query_ValueToSearch.setFont(font)
        ...
        font.setBold(True)
        font.setWeight(75)
        self.Query_Operator.setFont(font)
        ...
        self.DataTable_View = QtWidgets.QTableWidget(self.groupBox)
        font = QtGui.QFont()
        font.setFamily("Roboto Mono")
        font.setPointSize(9)
        self.DataTable_View.setFont(font)
        self.DataTable_View.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.DataTable_View.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.DataTable_View.setAlternatingRowColors(True)
        self.DataTable_View.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.DataTable_View.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.DataTable_View.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.DataTable_View.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.DataTable_View.setShowGrid(True)
        self.DataTable_View.setGridStyle(QtCore.Qt.DashLine)
        self.DataTable_View.setCornerButtonEnabled(False)
        self.DataTable_View.setObjectName("DataTable_View")
        self.DataTable_View.setColumnCount(0)
        self.DataTable_View.setRowCount(0)
        self.DataTable_View.verticalHeader().setVisible(False)
        self.DataTable_View.verticalHeader().setSortIndicatorShown(True)
        self.DataTable_View.verticalHeader().setStretchLastSection(False)
        self.horizontalLayout.addWidget(self.DataTable_View)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.StaffAct_Rollback.sizePolicy().hasHeightForWidth())
        self.StaffAct_Rollback.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Open Sans SemiBold")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.StaffAct_Rollback.setFont(font)
        self.StaffAct_Rollback.setObjectName("StaffAct_Rollback")
        self.horizontalLayout_4.addWidget(self.StaffAct_Rollback)
    ...
    def retranslateUi(self, Route88_DataViewer_Window):
        ...
        self.TableSystem_Selection.setItemText(0, _translate("Route88_DataViewer_Window", "None"))
        self.TableSystem_Selection.setItemText(1, _translate("Route88_DataViewer_Window", "Inventory Reference Data"))
        self.TableSystem_Selection.setItemText(2, _translate("Route88_DataViewer_Window", "Supplier Reference Data"))
        self.TableSystem_Selection.setItemText(3, _translate("Route88_DataViewer_Window", "Supplier Transaction Data"))
        self.TableSystem_Selection.setItemText(4, _translate("Route88_DataViewer_Window", "Customer Transaction Data"))
        self.TableSystem_Selection.setItemText(5, _translate("Route88_DataViewer_Window", "Customer Receipt Data"))
        self.TableSystem_Selection.setItemText(6, _translate("Route88_DataViewer_Window", "Employee Reference Data"))
        self.TableSystem_Selection.setItemText(7, _translate("Route88_DataViewer_Window", "Job Reference Data"))
        ...
        self.Query_ColumnOpt.setItemText(1, _translate("Route88_DataViewer_Window", "All Items"))
        ...
        self.DataTable_View.setSortingEnabled(True)
        ...
        self.StaffAct_Rollback.setText(_translate("Route88_DataViewer_Window", "Rollback Changes"))
