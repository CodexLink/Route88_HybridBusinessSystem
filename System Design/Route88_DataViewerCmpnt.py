...
class Ui_Route88_DataViewer_Window(object):
    ...
    def retranslateUi(self, Route88_DataViewer_Window):
        ...
        self.TableSystem_Selection.setItemText(2, _translate("Route88_DataViewer_Window", "Item Transaction Data"))
        self.TableSystem_Selection.setItemText(3, _translate("Route88_DataViewer_Window", "Supplier Reference Data"))
        self.TableSystem_Selection.setItemText(4, _translate("Route88_DataViewer_Window", "Supplier Transaction Data"))
        self.TableSystem_Selection.setItemText(5, _translate("Route88_DataViewer_Window", "Customer Transaction Data"))
        self.TableSystem_Selection.setItemText(6, _translate("Route88_DataViewer_Window", "Customer Receipt Data"))
        self.TableSystem_Selection.setItemText(7, _translate("Route88_DataViewer_Window", "Employee Reference Data"))
        self.TableSystem_Selection.setItemText(8, _translate("Route88_DataViewer_Window", "Job Refenrece Data"))
